        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/topics/create') }}" class="btn btn-success btn-sm" title="Add New topic">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>
<!--
                        <form method="GET" action="{{ url('/topics') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                                ...
                                @foreach($topics as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/topics/' . $item->id . '/edit') }}" title="Edit topic"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
